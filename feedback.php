...
<meta name="author" content="Pradeep Aadhi">
<meta name="email" content="pradeepp.2k2@gmail.com">
<meta name="copyright" content="Pradeep Aadhi 2023"/>
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="col-md-4">
     ...
     <div class="col-md-5">
    <a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook"><i class="fa fa-user"></i>&nbsp;Pradeep P</a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1"><i class="fa fa-phone"></i>&nbsp; +91-8610384094</h4>
    <h4 style="font-family:'typo' "><i class="fa fa-envelope"></i>&nbsp; pradeepp.2k2@gmail.com</h4>
    <h4 style="font-family:'typo' "><i class="fa fa-map-marker"></i>&nbsp; BIT Sathyamangalam</h4>
